...
const uploadImage = async(req, res) => {
    try {
        ...
        const newlyUploadedIamge = new Image({
            url,
            publicId,
            //we get this from authMiddleware which is used before imageMiddleware
            uploadedBy: '68935d0a23984074e668c2ab'
        });
        await newlyUploadedIamge.save();
